...
class incidentController extends CI_Controller {
	 ...
	 */
	 ...
	 function __construct() { 
      ...
      public function incidentreporttabledata()
	{
		...
		// Datatables Variables
         ...
         $user_data=$this->IncidentModel->getall_reports();
         $data = array();
         $no = $start;
		...
		foreach($user_data as $r) {
            ...
            $output = array(
                        "draw" => $draw,
                        "recordsTotal" => $this->IncidentModel->count_all(),
                        "recordsFiltered" => $this->IncidentModel->count_filtered(),
                        "data" => $data,
                );
