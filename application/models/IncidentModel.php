<?php 
   class IncidentModel extends CI_Model {
	 var $table = 'timeline_incident';
    var $column_order = array('id','year','slno','date','month','data','catagory'); //set column field database for datatable orderable
    var $column_search =array('id','year','slno','date','month','data','catagory'); //set column field database for datatable searchable just firstname , lastname , address are searchable
