    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <div class="form-group has-feedback">
        ...
        <input type="text" name="created_time" id="created_time" class="form-control"  autofocus="autofocus">
        </div>
        <div class="form-group has-feedback">
        <label>Expected Time</label>
        <input type="text" name="expected_time" id="expected_time" class="form-control"   autofocus="autofocus">
        </div>
        <div class="form-group has-feedback">
        <label>Updated Time</label>
        <input type="text" name="updated_time" id="updated_time" class="form-control"   autofocus="autofocus">
        </div>
        <div class="form-group has-feedback">
         <!-- <label>id</label> -->
...
//datatables
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url("task/datatablegetalltaskdata")?>",
            "type": "GET"
        },
