...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box-body">
          <form class="form-horizontal" id="form_role_list" method="post" action="<?php echo site_url('user/add_role'); ?>"> 
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Add New Role</label>
                  <div class="col-sm-8">
...
<div id="myModal" class="modal fade" role="dialog">
  ...
  <form name="roletypeform" id="roletypeform" class="roletypeform">
    <!-- Modal content-->
      ...
      <div class="modal-body">
        <p>
          <div class="form-group has-feedback">
            <label>Role</label>
        <input type="text" id="roletype" name="roletype" class="form-control">
        </div>
  ...
  $(document).ready(function() {
    ...
    $("#roletypeform").validate({
      rules: {
        ...
        messages: {
          roletype: "This field conot be empty",   
    ...
    $('.update_getbtn').click(function(){
       ...
       $.ajax({
                    type: "POST",
                    url: "<?php echo site_url(); ?>/role/get_roletype",
                    dataType : "json",
                    data: {"role_id":role_id},
                    success: function(response){
                          if(response)
                          {
                              $('#roletype').val(response[0].role);
    ...
    $('.update_btn').click(function(){
       ...
       $.ajax({
                    type: "POST",
                    url: "<?php echo site_url(); ?>/role/update_roletype",
                    data:{"roletype":roletype,"id":id},
                    dataType : "json",
                    success: function(response){
